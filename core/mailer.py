    ...
    for r in all_results:
        ...
        if flags:
            doc_id = (
                ...
                or r.get("supplier_invoice_number")
                or "Unknown"
            )
            flagged_pos.append((doc_id, flags, v.get("summary", "")))
...
def send_invoice_email(
    ...
    resolved_subject = subject or f"E-Invoices Ready — {po_count} POs, {line_item_count} Line Items{subject_suffix}"
